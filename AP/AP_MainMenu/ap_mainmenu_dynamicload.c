...
File name: ap_mainmenu_dynamicload.c
Creator: zj.zong					Date: 2009-04-24
Description: interface of main menu for dynamic loading functions
Others:
Version: V0.1
History:
...
#ifdef	AP_DYNAMICLOAD_ALL_MODE_DEF
...
void Ap_MainMenu_DynamicLoad_Music(void);
void Ap_MainMenu_DynamicLoad_Record(void);
void Ap_MainMenu_DynamicLoad_Voice(void);
void Ap_MainMenu_DynamicLoad_FM(void);
void Ap_MainMenu_DynamicLoad_System(void);
void Ap_MainMenu_DynamicLoad_Ebook(void);
void Ap_MainMenu_DynamicLoad_Telbook(void);

/*******************************************************************************
Function:   Ap_MainMenu_DanamicLoad_Music()
...
/*******************************************************************************
Function:   Ap_MainMenu_DynamicLoad_Record()
...
/*******************************************************************************
Function:   Ap_MainMenu_DynamicLoad_Voice()
...
/*******************************************************************************
Function:   Ap_MainMenu_DynamicLoad_FM()
...
/*******************************************************************************
Function:   Ap_MainMenu_DynamicLoad_Ebook()
...
/*******************************************************************************
Function:   Ap_MainMenu_DynamicLoad_System()
...
/*******************************************************************************
Function:   Ap_MainMenu_DynamicLoad_Telbook()
