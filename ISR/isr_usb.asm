...
File name: isr_usb.asm
Creator: zj.zong					Date: 2009-07-01
Description: process int
Others:
Version: V0.1
History:
	V0.1	2009-07-01		zj.zong
		 1. build this module
********************************************************************************/
#include "sh86278_compiler.h"
#ifdef ISR_USB_FUNC_DEF

#include "sh86278_sfr_reg.inc"
#include "ui_resident.h"
#include "ui_resident_var_ext.inc"

EXTRN	CODE	(_usb_ep0_isr)
EXTRN	CODE	(_usb_iep1_isr)
EXTRN	CODE	(_usb_oep2_isr)
