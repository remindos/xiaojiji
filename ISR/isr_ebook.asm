...
File name: ebook_func.asm
Creator: zj.zong					Date: 2009-06-15
Description: process int and basic func in ebook mode
Others:
Version: V0.1
History:
	V0.1	2008-06-15		zj.zong
		 1. build this module
********************************************************************************/
#include "sh86278_compiler.h"
#ifdef ISR_EBOOK_FUNC_DEF
